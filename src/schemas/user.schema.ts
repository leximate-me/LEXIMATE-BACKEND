...
const registerUserSchema = z.object({
  first_name: z
    .string()
    .min(5, 'El nombre es obligatorio y debe tener al menos 3 caracteres'),
  last_name: z
    .string()
    .min(5, 'El apellido es obligatorio y debe tener al menos 3 caracteres'),
  dni: z
    .string()
    .min(7, 'El DNI es obligatorio y debe tener al menos 7 caracteres'),
  institute: z
    .string()
    .min(2, 'El instituto es obligatorio y debe tener al menos 4 caracteres'),
